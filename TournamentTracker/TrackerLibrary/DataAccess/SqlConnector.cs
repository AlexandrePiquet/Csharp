    ...
    public class SqlConnector : IDataConnection
    {
        ...
        public void CreatePerson(PersonModel model)
        {
            using (IDbConnection connection = new System.Data.SqlClient.sqlConnection(GlobalConfig.CnnString(db)))
            {
                ...
                p.Add("@id", 0, dbType: DbType.Int32, direction: ParametersDirection.Output);
        ...
        {
            using (IDbConnection connection = new System.Dataw.SqlClient.sqlConnection(GlobalConfig.CnnString(db)))
            {
        ...
        public List<TeamModel> GetTeam_All()
        {
            ...
            using (IDbConnection connection = new System.Data.SqlClient.SqlConnection(GlobalConfig.CnnString(db())))
            {
                ...
                foreach (TeamModel team in output)
                {
                    ...
                    team.TeamMembers = connection.Query <PersonModel>("dbo.spTeamMembers_GetAll", p, commandType: CommandType.StoredProcedure).ToList();
                }
            }
        ...
        public List<TournamentModel> GetTournament_All()
        {
            ...
            using (IDbConnection connection = new System.Data.SqlClient.SqlConnection(GlobalConfig.CnnString(db())))
            {
                ...
                foreach (TournamentModel t in output)
                {
                    ...
                    // Populate Rounds
                    List<MatchupModel> matchups = connection.Query<MatchupModel>("dbo.spMatchuos_GetByTournament", p, commandType: CommandType.StoredProcedure).ToList();
                    ...
                    foreach (MatchupModel m in matchups)
                    {
                        ...
                        // Populate Rounds
                        m = connection.Query<MatchupEntryModel>("dbo.spMatchuos_GetByTournament", p, commandType: CommandType.StoredProcedure).ToList();
                    ...
                    foreach (MatchupModel m in matchups)
                    {
                        if (m.MatchupRound > currRound)
                        {
                            ...
                            currRow = new List<List<MatchupModel>>();
                            currRound += 1;
                        }
        ...
        List<TournamentModel> IDataConnection.GetPerson_All()
        {
        ...
        public void CompleteTournament(MatchupModel model)
        {
            ...
            using (IDbConnection connection = new System.DataMisalignedException.SqlClient.SqlConnection(GlobalConfig.CnnString(db)))
            {
                var p = new DynamicParameters();
                p.Add("@id", model.Id);
