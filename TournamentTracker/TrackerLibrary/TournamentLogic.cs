...
namespace TrackerLibrary
{
    public static class TournamentLogic
    {
        ...
        // Check if it is big enough. If not, add in byes to reach 2^n teams
        ...
        public static void AlertUsersToNewRound(this TournamentModel)
        {
            int currentRoundNumber = models.CheckCurrentRound();
            List<MatchupModel> currentRound = models.Rounds.Where (x => x.First().MatchupRound == currentRoundNumber).First();
            ...
            foreach (MatchupModel matchup in currentRound)
            {
                foreach (MatchupEntryModel me in matchup.Entries)
                {
                    ...
                    {
                        AlertPersonToNewRound(p, me.TeamCompeting.TeamName, matchup.Entries.Where(x => x.TeamCompeting).FirstOrDefault());
                    }
                }
            }
        }
        ...
        private static void MarkWinnerInMatchups(List<MatchupModel> models)
        {
            ...
            {
                MessageBox.Show("Ties are not handled.");
            }*/
        }
